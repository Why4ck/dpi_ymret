from engine.goodbyedpi import connector as g
from engine.zapret import connector as z
from engine.zapret2 import connector as z2
from engine.warp import connector as w
import asyncio
import os, sys
...
async def start_goodbyedpi():
    await g.run()

async def start_zapret():
    await z.run()

async def start_zapret2():
    await z2.run()

async def start_warp():
    await w.run()